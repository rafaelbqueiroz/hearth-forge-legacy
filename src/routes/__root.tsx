...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Lareiras e calefatores com aço industrial de até 12,7 mm, vedação Inconel e ventilação forçada. Engenharia honesta, calor que dura por gerações." },
      ...
      { name: "twitter:title", content: "Tochetto · Lareiras de Alto Rendimento" },
      { name: "twitter:description", content: "Lareiras e calefatores com aço industrial de até 12,7 mm, vedação Inconel e ventilação forçada. Engenharia honesta, calor que dura por gerações." },
    ],
    links: [
